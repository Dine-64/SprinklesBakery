...
public class GradutionCupCake extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gradution_cup_cake);
    ...
    private void navigateToCart(String price) {
        ...
        Intent intent = new Intent(GradutionCupCake.this, ShippingDetails.class);
